...
let BusinessBriefcaseCash = (props) => (
  <SvgIcon {...props}>
...
BusinessBriefcaseCash = pure(BusinessBriefcaseCash)
BusinessBriefcaseCash.displayName = 'BusinessBriefcaseCash';

export default BusinessBriefcaseCash;
